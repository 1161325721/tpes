...
public class SysmgrServiceImpl implements SysmgrService
{
	...
	public LayuiTableDate reqGroupListByCondition(HashMap<String, Object> condition)
	{
		LayuiTableDate date = new LayuiTableDate();
		date.setCount(groupClientMapper.findGroupCountByCondition(condition));
		date.setData(groupClientMapper.findGroupByCondition(condition));
		return date;
	}
	...
	public void editGroup(HashMap<String, Object> condition)
	{
		...
		Object ob = condition.get("gcpass");
		if (null!=ob){
			ob = Md5utils.getMD5LowerCase((String)ob);
			condition.put("gcpass",ob);
		}
	...
	public int addGroup(HashMap<String, Object> condition)
	{
		...
		try
		{
			condition.put("gcregisterdate",new Date());
			i = groupClientMapper.add(condition);
		}catch (Exception e){
	...
	public LayuiTableDate reqWorkerListByCondition(HashMap<String, Object> condition)
	{
		LayuiTableDate data = new LayuiTableDate();
		data.setCount(workerMapper.findCountByCondition(condition));
		data.setData(workerMapper.findByCondition(condition));
		return data;
	}
	...
	{
		return workerMapper.del(condition);
	}
	...
	public LayuiTableDate reqLogListByCondition(HashMap<String, Object> condition)
	{
		LayuiTableDate data = new LayuiTableDate();
		data.setCount(logMapper.findCountByCondition(condition));
		data.setData(logMapper.findByCondition(condition));
		return data;
	}
