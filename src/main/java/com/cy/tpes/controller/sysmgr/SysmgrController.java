...
public class SysmgrController
{
	...
	@RequestMapping(path = "addGroup",produces = "application/json")
	@ResponseBody
	public Object addGroup(@RequestParam(value = "condition",required=false) HashMap<String,Object> condition){
		String msg = "false";
		if (sysmgrService.addGroup(condition)>0){
			msg = "true";
		}
		return msg;
	}
	...
	@RequestMapping(path = "reqAllLogList",produces = "application/json")
	@ResponseBody
	public Object reqAllLogList(@RequestParam(value = "condition",required=false) HashMap<String,Object> condition)
	{

		return sysmgrService.reqLogListByCondition(condition);
	}
