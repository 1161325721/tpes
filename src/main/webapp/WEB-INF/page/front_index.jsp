...
<%--						<p>营业时间 : 8：00 - 22：00  联系电话 : <span>+86-123-456-7890</span></p>--%>
					</div>
				</div>
			</div>
		</div>
...
<%--							<a class="navbar-brand" href="index.html"><img src="img/core-img/logo.png" alt="Logo"></a>--%>
							...
							<div class="collapse navbar-collapse" id="medilifeMenu">
								...
								<ul class="navbar-nav ml-auto">
									<li class="nav-item">
										<a class="nav-link" href=<%=path+"sysmgr/page/facelogin"%>>登陆</a>
									</li>
								</ul>
								<!-- Appointment Button -->
		...
		<div class="row">
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-cool-fact-area text-center mb-100">
					...
					<h2><span class="counter">${requestScope.info.chcount}</span></h2>
					<h6>累计体检</h6>
<%--					<p>Dolor sit amet, consecte tuer adipiscing elit, sed diam nonummy nibh euismod tincidunt.</p>--%>
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-cool-fact-area text-center mb-100">
					...
					<h2><span class="counter">${requestScope.info.gccount}</span></h2>
					<h6>合作单位</h6>
<%--					<p>Dolor sit amet, consecte tuer adipiscing elit, sed diam nonummy nibh euismod tincidunt.</p>--%>
				</div>
			</div>
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-cool-fact-area text-center mb-100">
					...
					<h2><span class="counter">${requestScope.info.dcount}</span></h2>
					<h6>科室数量</h6>
<%--					<p>Dolor sit amet, consecte tuer adipiscing elit, sed diam nonummy nibh euismod tincidunt.</p>--%>
				</div>
			</div>
			...
			<div class="col-12 col-sm-6 col-lg-3">
				<div class="single-cool-fact-area text-center mb-100">
					...
					<h2><span class="counter">${requestScope.info.wcount}</span></h2>
					<h6>工作人员</h6>
<%--					<p>Dolor sit amet, consecte tuer adipiscing elit, sed diam nonummy nibh euismod tincidunt.</p>--%>
				</div>
			</div>
