...
<%--	//todo xml还没写--%>
	<script src=<%=path+"resources/js/hwx_people_stat.js"%>></script>
...
<body>
<div>
	<input type="button" value="实际体检/总人数对比" onclick="btnsearch1()">

</div>
<div>
	<input type="text" id="goid" name="goid" placeholder="请输入订单号">
</div>
