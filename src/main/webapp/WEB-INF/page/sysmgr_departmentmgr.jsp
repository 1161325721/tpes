...
<head>
	...
	<script type="text/javascript" src=<%=path + "resources/js/sysmgr_departmentmgr.js"%>></script>
	<style>
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="dname" lay-verify="required" placeholder="请输入科室名" autocomplete="off" class="layui-input">
				</div>
			</div>
		</div>
	...
	<div style="display:none;" id="editDiv">
		...
		<form action="" method="post" class="layui-form" id="editForm" lay-filter="editForm">
			...
			<div class="layui-form-item" id="idDiv">
				...
				<div class="layui-input-inline">
					<input type="text" name="did" class="layui-input" style="border-style: none" disabled>
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="dname" required  lay-verify="required" placeholder="请输入科室名称" autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="ddescription" required  lay-verify="required" placeholder="请输入科室描述" autocomplete="off" class="layui-input">
				</div>
			</div>
