...
<head>
	...
	<script src=<%=path+"resources/js/hwx_sale_echarts.js"%>></script>
...
<body>
<div>
	<input type="button" value="年接收项目" onclick="btnsearch1()">
	<input type="button" value="月接收项目" onclick="btnsearch2()">
	<input type="button" value="周接收项目" onclick="btnsearch3()">
