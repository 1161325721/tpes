...
<form action="${pageContext.request.contextPath}/facelogin.action" method="get">
	<dl class="admin_login">
		...
		<dd>
			<input  type="button" onclick="loginuser()" value="立即登录" class="submit_btn" id="login">

		</dd>
		<div><a href=<%=path+"/back/"%>>账号密码登陆</a></div>
		...
		function loginuser() {
			...
			$.ajax({
				...
				success: function (data) {
					...
					if (result) {
						new TipBox({type: 'success', str: '人脸识别成功', hasBtn: true},function () {
