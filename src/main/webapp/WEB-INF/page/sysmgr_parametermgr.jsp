...
<head>
	...
	<script type="text/javascript" src=<%=path + "resources/js/sysmgr_parametermgr.js"%>></script>
	<style>
		...
		<div class="layui-form-item">
			<div class="layui-inline">
				...
				<div class="layui-input-inline">
					<input type="text" name="paraname" lay-verify="required" placeholder="请输入参数名" autocomplete="off" class="layui-input">
				</div>
			</div>
		</div>>
	...
	<div style="display:none;" id="editDiv">
		...
		<form action="" method="post" class="layui-form" id="editForm" lay-filter="editForm">
			...
			<div class="layui-form-item" id="idDiv">
				...
				<div class="layui-input-inline">
					<input type="text" name="paraid" class="layui-input" style="border-style: none" disabled>
				</div>
			</div>
			...
			<div class="layui-form-item">
				<label class="layui-form-label">参数名称：</label>
				<div class="layui-input-inline">
					<input type="text" name="paraname" required  lay-verify="required" placeholder="请输入参数名称" autocomplete="off" class="layui-input">
				</div>
			</div>
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-inline">
					<input type="text" name="paravalue" required  lay-verify="required" placeholder="请输入参数值" autocomplete="off" class="layui-input">
				</div>
			</div>
