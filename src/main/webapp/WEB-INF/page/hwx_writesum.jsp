...
<div id="showsum" style="display: none;width:600px;height:800px ">
	...
	<div style="float: left;width: 300px;height: 300px;" >
		...
		<textarea class="layui-textarea" name="sumtext1" id="sumtext1" cols="40" rows="11"  placeholder="小结内容" readonly style="width: 300px;height: 300px;"></textarea>
	</div>
...
<%--	<button class="layui-btn" lay-event="findsum">查看总结</button>--%>
	<a class="layui-btn layui-btn-normal mydown" lay-event="printsum"  >生成报告</a>
	<a class="layui-btn layui-btn-normal mydown" lay-event="downdoc"  onclick="return confirm('确认下载吗？？')" >下载</a>
<%--	<button class="layui-btn" lay-event="printsum"><a href="/tpes/downDoc"   id="download" >下载报告</a></button>--%>
</script>
<%--查看图片--%>
		...
		table.on('tool(itemlist)', function(obj){
			...
			switch(obj.event){
				...
				case 'openpic':
					...
					$('#sumtext1').text(cpsummary);
					$('#wname1').text(text);
					$('#sumimg').attr('src',pic); //图片链接（base64）
