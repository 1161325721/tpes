...
<div class="demoTable">
	...
	交易类型：
	<div class="layui-inline">
		<input type="text" class="layui-input" name="type" id="type" autocomplete="off">
	</div>
	体检时间：
	<div class="layui-inline">
...
<script>
	layui.use(['table','jquery'], function(){
		...
		table.render({
			elem: '#LAY_table_user'
			,url: $2('#path').val()+'/yeFundTable.do'
			,cols: [[ //表头
				{field: 'gcname', title: '单位名称', width:15+'%'}
				// templet:function (d) {
				// 	return d.id ==1?"男":"女";}
				,{field: 'gcaccount', title: '单位账号', width:15+'%'}
				,{field: 'fttype', title: '交易类型', width:13+'%'}
				,{field: 'ftamount', title: '交易金额', width:13+'%'}
				,{field: 'stringDate', title: '交易时间', width:20+'%' }
