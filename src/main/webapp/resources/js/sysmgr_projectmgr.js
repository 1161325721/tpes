	...
	layui.use(['table','form','layer','transfer'], function(){
		...
		table.render({
			...
			,cols: [[ //表头
				...
				,{field: 'pname', title: '项目名称', width:150,align:'center'}
				,{field: 'pcharge', title: '项目价格', width:150,align:'center'}
				,{field: 'pgender', title: '适用性别', width:150,align:'center'}
				,{field: 'did', title: '科室', width:150,align:'center'}
